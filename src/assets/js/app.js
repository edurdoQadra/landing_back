document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateForm() {
    ...
    // Validación del checkbox de edad
        if (!ageOver18.checked) {
            showErrorMessage('alert_over18', 'You must confirm that you are over 18 years old');
            isValid = false;
        } else {
            clearErrorMessage('alert_over18');
        }
